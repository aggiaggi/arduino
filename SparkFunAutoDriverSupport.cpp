...
{
  float temp = stepsPerSecPerSec * 0.137438 / 2.0;
...
{
    return (float) (stepsPerSecPerSec & 0x00000FFF) / 0.137438 * 2.0;
}
...
byte AutoDriver::SPIXfer(byte data)
{
  ...
  _SPI->beginTransaction(SPISettings(400000, MSBFIRST, SPI_MODE3));
